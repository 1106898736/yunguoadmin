  ...
  <div class="app-container">
    ...
    <el-card class="box-card">
      ...
      <el-form ref="goods" :rules="rules" :model="goods" label-width="150px">
        <el-form-item label="资讯类别" prop="type">
        ...
        <el-form-item label="是否启用" prop="isNew">
          <el-radio-group v-model="goods.enabled">
        ...
        <el-form-item label="资讯标题" prop="brief">
          <el-input v-model="goods.brief" type="textarea" maxlength="20"/>
        </el-form-item>
        <el-form-item label="资讯内容" prop="detail">
...
<script>
import { publishInfos, listCatAndBrand } from '@/api/info'
...
export default {
  ...
  data() {
    return {
      ...
      categoryList: [],
      brandList: [],
      goods: { picUrl: '', gallery: [], brief: '', name: '', type: '', detail: '', enabled: 'true', isHot: 'false' },
      specVisiable: false,
  ...
  methods: {
    ...
    handlePublish: function() {
      ...
      publishInfos(finalGoods.goods).then(response => {
        this.$notify.success({
          title: '成功',
          message: '创建成功'
        })
