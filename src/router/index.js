...
export const asyncRoutes = [
    ...
    children: [
      {
        ...
        name: 'carousel',
        meta: {
          perms: ['GET /admin/home/carousel/list', 'POST /admin/home/carousel/delete'],
          title: '轮播图管理',
          noCache: true
        }
      },
      {
        path: 'list',
        component: () => import('@/views/home/introduce/list'),
        name: 'introduceList',
        meta: {
          perms: ['GET /admin/home/introduce/list', 'POST /admin/home/introduce/delete'],
          title: '介绍列表',
          noCache: true
        }
      },
      {
        path: 'introduceCreate',
        component: () => import('@/views/home/introduce/create'),
        name: 'introduceCreate',
        meta: {
          perms: ['POST /admin/home/introduce/create'],
          title: '介绍添加',
          noCache: true
        }
      },
      {
        path: 'introduceEdit',
        component: () => import('@/views/home/introduce/edit'),
        name: 'introduceEdit',
        meta: {
          perms: ['GET /admin/home/provide/detail', 'POST /admin/home/provide/update', 'POST /admin/home/provide/catAndBrand'],
          title: '介绍编辑',
          noCache: true
        },
        hidden: true
      ...
      {
        path: 'provide',
        component: () => import('@/views/home/provide/ad'),
        name: 'provide',
        meta: {
          perms: ['GET /admin/home/provide/list', 'POST /admin/provide/create', 'GET /admin/provide/read', 'POST /admin/provide/update', 'POST /admin/provide/delete'],
          title: '供货管理',
          noCache: true
        }
      }]
  },
  {
    ...
    children: [
      {
        path: 'list',
        component: () => import('@/views/home/info/list'),
        name: 'introduceList',
        meta: {
          perms: ['GET /admin/home/info/list', 'POST /admin/home/info/delete'],
          title: '资讯列表',
          noCache: true
        }
      },
      {
        path: 'infoEdit',
        component: () => import('@/views/home/info/infoedit'),
        name: 'infoEdit',
        meta: {
          perms: ['GET /admin/home/info/detail', 'POST /admin/home/info/update', 'POST /admin/home/info/catAndBrand'],
          title: '资讯编辑',
          noCache: true
        },
        hidden: true
      ...
      {
        path: 'infoCreate',
        component: () => import('@/views/home/info/create'),
        name: 'infoCreate',
        meta: {
          perms: ['POST /admin/home/info/create'],
          title: '资讯添加',
          noCache: true
        }
      }]
